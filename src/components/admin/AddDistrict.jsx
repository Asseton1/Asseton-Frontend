...
const AddDistrict = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await propertyAPI.createDistrict({
        ...formData,
      ...
      setError(err.message || 'Failed to add district. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-2xl mx-auto px-3 sm:px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Add New District</h1>
          <p className="mt-2 text-sm sm:text-base text-gray-600">Add a new district to the location database</p>
        </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-green-800">
                  District added successfully! Redirecting to dashboard...
                </p>
              </div>
            </div>
          </div>
