  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <div className="container mx-auto container-padding pt-16 pb-8">
        ...
        <div className="responsive-grid-4 gap-10 mb-12">
          {/* Brand section */}
          <div className="space-y-4">
            <Link to="/" className="inline-block">
              <span className="flex items-center">
                <img 
                  src={logo} 
                  alt="Asseton Logo" 
                  className="h-11 sm:h-13 md:h-15 lg:h-20 w-auto max-w-[140px] sm:max-w-[160px] md:max-w-[180px] lg:max-w-[200px] rounded-md object-cover" 
            ...
            <div className="flex space-x-4 pt-4">
              <a href="https://www.facebook.com/profile.php?id=61559045518736" className="bg-white/10 hover:bg-white/20 p-2.5 rounded-full transition-all duration-300">
                <FaFacebookF className="text-white text-sm" />
              </a>
              
              <a href="https://www.instagram.com/asseton.in?igsh=MWdlMTlrZDZwcTZkbw%3D%3D&utm_source=qr" className="bg-white/10 hover:bg-white/20 p-2.5 rounded-full transition-all duration-300">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><Link to="/property-listing?search=apartments" className="text-gray-400 hover:text-white transition-colors flex items-center"><span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>Apartments</Link></li>
              <li><Link to="/property-listing?search=villas" className="text-gray-400 hover:text-white transition-colors flex items-center"><span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>Villas</Link></li>
              <li><Link to="/property-listing?search=commercial" className="text-gray-400 hover:text-white transition-colors flex items-center"><span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>Commercial</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Vattoly Annexe, 2nd Floor SRM Road Cochin 682018 Kerala, India</span>
              </li>
              <li className="flex items-center">
                <FaPhone className="text-blue-400 mr-3" />
                <span className="text-gray-400">+91 952661555</span>
              </li>
              <li className="flex items-center">
                <FaEnvelope className="text-blue-400 mr-3" />
                <span className="text-gray-400">asseton@asseton.in</span>
              </li>
              <li className="mt-6">
                <a 
                  href="https://wa.me/9526661555" 
                  target="_blank"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Asseton All rights reserved.</p>
          <div className="mt-4 md:mt-0 flex space-x-6">
            <Link to="/privacy-policy" className="hover:text-white transition-colors">Privacy Policy & Terms of Service</Link>
