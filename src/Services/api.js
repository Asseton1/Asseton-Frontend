    ...
    try {
      if (import.meta.env.DEV) {
        console.log(
          ...
          `${apiConfig.baseURL}/accounts/login/`,
        );
      }
...
export const propertyAPI = {
  ...
  getAllProperties: async (params = {}) => {
    try {
      ...
      if (params.property_for)
        queryParams.append("property_for", params.property_for);

      // Furnishing
      if (params.furnishing)
        queryParams.append("furnishing", params.furnishing);
      ...
      if (response && response.data) {
        ...
        // If response.data is not an array, return empty results
          ...
          console.warn(
            "[API] Unexpected response format for getAllProperties:",
            response.data,
          );
          return {
            results: [],
  ...
  getDistricts: async (stateId) => {
    try {
      const response = await apiClient.get(
        `/properties/districts/?state=${stateId}`,
      );
      return response.data;
    } catch (error) {
  ...
  getCities: async (districtId) => {
    try {
      const response = await apiClient.get(
        `/properties/cities/?district=${districtId}`,
      );
      return response.data;
    } catch (error) {
  ...
  createProperty: async (propertyData) => {
    try {
      ...
      if (error.response?.data) {
        ...
        throw new Error(
          errorData.detail || errorData.message || "Failed to create property",
        );
      }
      throw new Error(
        "Failed to create property. Please check your connection and try again.",
      );
    }
  },
  ...
  updateProperty: async (id, propertyData) => {
    try {
      ...
      if (error.response?.data) {
        ...
        throw new Error(
          errorData.detail || errorData.message || "Failed to update property",
        );
      }
      throw new Error(
    ...
    try {
      ...
      if (response && response.data) {
        ...
        // If response.data is not an array, return empty array
          ...
          console.warn(
            "[API] Unexpected response format for getAllContacts:",
            response.data,
          );
          return [];
        }
  ...
  getSiteSettings: async () => {
    try {
      const response = await apiClient.get("/properties/site-settings/");
      return response.data;
    } catch (error) {
      throw error.response?.data || error.message;
    }
